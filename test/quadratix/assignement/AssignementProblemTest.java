...
import quadratix.graphic.GraphvizGenerator;
...
class AssignementProblemTest {
    ...
    void setUp(){
        ...
        try {
            assignementProblem.taillardInitializer("tai30a.txt");
...
//        assignementProblem.setInCombination(new Combination(1,3,4,5,2));
    ...
    void algorithm(){
        ...
        // Following part need graphviz enable on pc
//        String graphContent = GraphvizGenerator.buildGraph(assignementProblem.getOutCombination(),assignementProblem.getAssignementData());
//        try {
//            GraphvizGenerator.generateGraphFile(graphContent);
//            GraphvizGenerator.generateGraphImage();
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
    }
